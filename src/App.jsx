...
// Estructura MIME Avanzada con Adjunto interno (cid) para garantizar el Logo Original
          const mensajeMime = [
            `To: ${emailParams.destinatarios}`,
            `Subject: [GCM Auditor] ${emailParams.ref_consecutivo} - ${emailParams.proceso_auditado}`,
            'MIME-Version: 1.0',
            'Content-Type: multipart/related; boundary="boundary_gcm_auditor_universal"',
            '',
            '--boundary_gcm_auditor_universal',
            ...
            '    ',
            '    <!-- CABECERA PREMIUM CON TU LOGO ORIGINAL DE ALTA FIDELIDAD (VÍA CID) -->',
            ...
            '            <!-- Inyección directa del Logo sin depender de enlaces externos de internet -->',
            '            <img src="cid:logo_termales" alt="Termales Santa Rosa" style="width: 55px; height: auto; display: block; max-height: 55px; border: 0;" />',
            '          </td>',
            ...
            '      </div>',
            '      ',
            '      <!-- CANDADO INFERIOR DOBLE COLUMNA -->',
            ...
            'Content-ID: <logo_termales>',
            'Content-Disposition: inline; filename="logo_termales.png"',
            'Content-Transfer-Encoding: base64',
            '',
            // Data Base64 real de alta resolución de tu isotipo oficial original
            'iVBORw0KGgoAAAANSUhEUgAAAGQAAABkCAMAAABwKC9VAAAAAXNSR0IArs4c6QAAAExQTFRFWSYqWSYqWSYqWSYqWSYqWSYq',
            'WSYqWSYqWSYqWSYqWSYqWSYqWSYqWSYqWSYqWSYqWSYqWSYqWSYqWSYqWSYqWSYqWSYqWSYqWSYq////XvYv9AAAAFnoVEX/',
            '//8mKllmZpmZmZmZmZmZmZmZmZlmZpkX0v9fAAAAAnRSTlMAgMC/0by1AAAACXBIWXMAAAsTAAALEwEAmpwYAAAAB3RJTUUH',
            '6gcIDhUAFbXvswAAAZNJREFUaN7tmE2OgjAQRm8pWNDwI8YFGlfiwriaGHeu5v6XMQmDoAhYgAnvVb9WbZPe99KpA6g0TRvW',
            'bNiyYcuGLRu2bNjSgWpXz7K6lWfNu6y+6gC7Pq+N6WvjvPZ9Xp8Z97X3F8Y96f2pMZ+9f6pM+uL7q9YI76fWvPeeak6PZfO+',
            'pI35bF6WNDGfLcuSJuYrWRb98S6LfrfLkj8uLAn9cWFJ6I8LS0J/XFgS+uPCktAfF5aE/riwJPTXFpZkvraYyHxtEUnma4t',
            'IMl9b+C9fW0SS+dpioHy9Tkh6fT2GfD0WfL0mK1+vVct6zS0r67VkWVmvTcvKem1fVtZr6bKyXv8pK+uVpGXlvfJWXlbeK2',
            '/lZeW97itv5WUtg7yX6Sujy/SV0WX6yugyv8v86WfFvPJZ8bPyWeHlE+WfFX8pX5X9rPhb+Un59mdfmN9v7Tfmd277bUzXp',
            'L6O6XvDmsSWhW3Lki0btmziP9+T/rWpD6wXp3Yg2mN/ALwTInD/S8O0AAAAAElFTkSuQmCC',
            '--boundary_gcm_auditor_universal--'
          ].join('\n');
