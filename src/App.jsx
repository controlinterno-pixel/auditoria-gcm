...
export default function App() {
  ...
  const renderPlanAnual = () => {
    ...
    // --- LÓGICA DE ORDENAMIENTO ROBUSTA PARA PLAN ANUAL ---
        ...
        <div className="bg-white rounded-3xl shadow-sm border overflow-hidden">
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-4 gap-6">
             <div className="md:col-span-1 space-y-6">
                ...
                <div id="edit-form" className="border rounded-2xl overflow-hidden shadow-sm">
                   ...
                   <div className="divide-y p-2">
                     {editMonitoreo && isAdmin && (
                       <form onSubmit={(e) => handleSubmits(e, 'moni')} key={`moni-form-${formResetKey}`} className="p-3 bg-slate-50 rounded-lg mb-2 border">
                         ...
                         <select name="tendencia" defaultValue={editMonitoreo.tendencia||'flat'} className="w-full text-xs p-1.5 mb-2 border rounded">
                           <option value="up">Tendencia al Alza</option><option value="down">Tendencia a la Baja</option><option value="flat">Estable</option>
                         </select>
