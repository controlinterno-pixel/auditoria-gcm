      ...
      <nav className="flex-1 px-4 py-4 space-y-1 text-xs font-medium overflow-y-auto custom-scrollbar">
        ...
        <div className="flex flex-col">
          <button 
            ...
            className={`flex items-center justify-between w-full px-4 py-3 rounded-xl transition-all duration-200 ${(activeTab === 'tablero' || activeTab === 'dashboard_riesgos') ? 'bg-blue-600 text-white shadow-md shadow-blue-900/40' : 'hover:bg-slate-800/60 text-slate-400 hover:text-slate-200'}`}>
        ...
        <div className="flex flex-col">
          <button 
            ...
            className={`flex items-center justify-between w-full px-4 py-3 rounded-xl transition-all duration-200 ${activeTab === 'plan_anual_tab' && (subTabPlanificar === 'riesgos' || subTabPlanificar === 'apetito') ? 'bg-blue-600 text-white shadow-md shadow-blue-900/40' : 'hover:bg-slate-800/60 text-slate-400 hover:text-slate-200'}`}>
            <div className="flex items-center gap-3">
        ...
        {isAdmin && (
          <div className="flex flex-col">
            <button 
              ...
              className={`flex items-center justify-between w-full px-4 py-3 rounded-xl transition-all duration-200 ${activeTab === 'gobernanza_tab' ? 'bg-blue-600 text-white shadow-md shadow-blue-900/40' : 'hover:bg-slate-800/60 text-slate-400 hover:text-slate-200'}`}>
              <div className="flex items-center gap-3">
