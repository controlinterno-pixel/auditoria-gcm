...
// Estructura Sobria y Elegante basada exactamente en la Maqueta Light de Termales
          const mensajeMime = [
            ...
            '    ',
            '    <!-- CABECERA LIMPIA Y SOBRIA CON LOGO CORPORATIVO DIRECTO DEL SERVIDOR OFICIAL -->',
            '    <div style="padding: 30px 25px 20px 25px; text-align: left; background-color: #ffffff; border-bottom: 1px solid #f1f5f9;">',
            '      <table style="width: 100%; border-collapse: collapse;">',
            '        <tr>',
            '          <td style="width: 65px; vertical-align: middle;">',
            '            <img src="https://termales.com.co/wp-content/uploads/2023/11/logo-termales-santa-rosa-de-cabal.png" alt="Termales" style="width: 55px; height: auto; display: block; max-height: 55px;" />',
            '          </td>',
