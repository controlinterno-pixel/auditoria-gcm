    ...
    try {
      const tokenClient = window.google.accounts.oauth2.initTokenClient({
        ...
        callback: async (tokenResponse) => {
          ...
          // Estructura Premium Maquetada basada en la identidad de Termales Santa Rosa de Cabal
          const mensajeMime = [
            ...
            '',
            `<div style="background-color: #060b16; padding: 30px 15px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; min-height: 100%; width: 100%; box-sizing: border-box; text-align: center;">`,
            `  <div style="max-width: 520px; background-color: #0a1122; border: 1px solid #1e293b; border-radius: 24px; padding: 35px 25px; margin: 0 auto; text-align: left; box-shadow: 0 20px 40px rgba(0,0,0,0.5); overflow: hidden;">`,
            `    `,
            `    `,
            `    <div style="text-align: center; margin-bottom: 25px; border-bottom: 2px solid #297A38; padding-bottom: 20px;">`,
            `      <img src="https://auditoria-gcm.vercel.app/logo_termales.png" alt="Termales Santa Rosa de Cabal" style="width: 160px; height: auto; display: block; margin: 0 auto;" />`,
            `      <p style="color: #297A38; margin: 12px 0 0 0; font-size: 9px; font-weight: 800; letter-spacing: 3px; text-transform: uppercase;">PLATAFORMA GCM AUDITOR</p>`,
            `    </div>`,
            `    `,
            `    `,
            `    <div style="text-align: center; margin-bottom: 25px;">`,
            `      <div style="font-size: 11px; font-weight: 800; color: #10b981; letter-spacing: 1.5px; text-transform: uppercase; margin-bottom: 4px;">NUEVO INFORME RADICADO</div>`,
            `      <div style="font-size: 34px; font-weight: 900; color: #ffffff; tracking-key: -0.5px; margin-bottom: 4px;">${emailParams.ref_consecutivo}</div>`,
            `      <p style="font-size: 12px; color: #94a3b8; margin: 8px 0 0 0; font-weight: 500; line-height: 1.4;">Se ha registrado y liberado un nuevo dictamen en el repositorio oficial de Control Interno.</p>`,
            `    </div>`,
            `    `,
            `    `,
            `    <div style="display: table; width: 100%; margin-bottom: 25px; border: 1px solid #1e293b; border-radius: 16px; background-color: #0e1629; border-collapse: separate; border-spacing: 0;">`,
            `      <div style="display: table-row;">`,
            `        <div style="display: table-cell; width: 50%; padding: 14px; text-align: center; border-right: 1px solid #1e293b;">`,
            `          <span style="font-size: 8px; font-weight: 800; color: #64748b; text-transform: uppercase; display: block; letter-spacing: 1px; margin-bottom: 4px;">ESTADO</span>`,
            `          <span style="font-size: 13px; font-weight: 900; color: #ffffff;"><span style="color: #10b981; margin-right: 4px;">●</span> NUEVO</span>`,
            `        </div>`,
            `        <div style="display: table-cell; width: 50%; padding: 14px; text-align: center;">`,
            `          <span style="font-size: 8px; font-weight: 800; color: #64748b; text-transform: uppercase; display: block; letter-spacing: 1px; margin-bottom: 4px;">PRIORIDAD</span>`,
            `          <span style="font-size: 13px; font-weight: 900; color: #ef4444;"><span style="margin-right: 4px;">🚩</span> ALTA</span>`,
            `        </div>`,
            `      </div>`,
            `    </div>`,
            `    `,
            `    `,
            `    <div style="border: 1px solid #1e293b; border-radius: 16px; background-color: #0e1629; padding: 4px 15px; margin-bottom: 25px;">`,
            `      <table style="width: 100%; border-collapse: collapse; font-size: 12px; font-weight: 500;">`,
            `        <tr style="border-bottom: 1px solid #1e293b;"><td style="padding: 12px 0; color: #64748b; font-weight: 700;">💼 Módulo / Proceso:</td><td style="padding: 12px 0; color: #ffffff; font-weight: 800; text-align: right; text-transform: capitalize;">${emailParams.proceso_auditado}</td></tr>`,
            `        <tr style="border-bottom: 1px solid #1e293b;"><td style="padding: 12px 0; color: #64748b; font-weight: 700;">👤 Responsable Emisor:</td><td style="padding: 12px 0; color: #ffffff; font-weight: 800; text-align: right;">${nombreAuditorIdentificado}</td></tr>`,
            `        <tr><td style="padding: 12px 0; color: #64748b; font-weight: 700;">📅 Tipo de Novedad:</td><td style="padding: 12px 0; color: #10b981; font-weight: 800; text-align: right;">Informe de Auditoría</td></tr>`,
            `      </table>`,
            `    </div>`,
            `    `,
            `    `,
            `    <div style="border: 1px solid rgba(16,185,129,0.2); border-radius: 16px; background-color: rgba(16,185,129,0.04); padding: 15px 20px; margin-bottom: 25px;">`,
            `      <div style="font-size: 9px; font-weight: 900; color: #10b981; letter-spacing: 1px; margin-bottom: 6px; text-transform: uppercase;">RESUMEN DEL DICTAMEN</div>`,
            `      <div style="font-size: 13px; color: #e2e8f0; font-weight: 600; line-height: 1.5;">${emailParams.titulo_informe}</div>`,
            `    </div>`,
            `    `,
            `    `,
            `    <div style="text-align: center; margin-bottom: 25px;">`,
            `      <a href="${emailParams.enlace_pdf}" style="display: block; background-color: #10b981; color: #ffffff; font-size: 12px; font-weight: 800; text-decoration: none; padding: 14px 20px; border-radius: 12px; box-shadow: 0 4px 15px rgba(16,185,129,0.3); text-transform: uppercase; letter-spacing: 1px; text-align: center;">`,
            `        Ver Informe Completo &nbsp; ➔`,
            `      </a>`,
            `    </div>`,
            `    `,
            `    `,
            `    <div style="text-align: center; border-top: 1px solid #1e293b; padding-top: 20px; font-size: 9px; color: #475569; font-weight: 600; line-height: 1.5;">`,
            `      🔒 Para ver el desglose, evidencias adjuntas, gestionar los hallazgos vinculados y responder la matriz operativa, ingrese con sus credenciales autorizadas en la app web de GCM Auditor.`,
            `    </div>`,
            `    `,
            `  </div>`,
            `</div>`
