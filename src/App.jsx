...
// Estructura Premium Exacta basada en la Maqueta de Termales Santa Rosa de Cabal
          const mensajeMime = [
            ...
            '',
            `<div style="background-color: #040812; padding: 20px 10px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; min-height: 100%; width: 100%; box-sizing: border-box; text-align: center;">`,
            `  <div style="max-width: 500px; background-color: #070d19; border: 1px solid #111a2e; border-radius: 24px; padding: 0; margin: 0 auto; text-align: left; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.7); overflow: hidden;">`,
            `    `,
            `    `,
            `    <div style="padding: 30px 25px 20px 25px; text-align: left; border-bottom: 2px solid #10b981;">`,
            ...
            `          </td>`,
            `          <td style="padding-left: 12px; vertical-align: middle; leading-height: 1.1;">`,
            `            <div style="color: #ffffff; font-size: 15px; font-weight: 900; letter-spacing: 1px; font-family: sans-serif;">GCM AUDITOR</div>`,
            `            <div style="color: #94a3b8; font-size: 10px; font-weight: 700; letter-spacing: 1.5px; margin-top: 2px;">Gestión • Control • Mejora</div>`,
            `          </td>`,
            `        </tr>`,
            `      </table>`,
            `    </div>`,
            ...
            `        <div style="display: inline-block; width: 48px; height: 48px; line-height: 48px; border-radius: 50%; border: 1px solid #10b981; text-align: center; font-size: 20px; color: #10b981; background-color: rgba(16,185,129,0.05);">📄</div>`,
            `      </div>`,
            `      `,
            `      `,
            `      <div style="text-align: center; margin-bottom: 25px;">`,
            `        <div style="font-size: 11px; font-weight: 800; color: #10b981; letter-spacing: 2px; text-transform: uppercase; margin-bottom: 6px;">NUEVO INFORME</div>`,
            `        <div style="font-size: 36px; font-weight: 900; color: #ffffff; letter-spacing: -1px; margin-bottom: 12px;">${emailParams.ref_consecutivo}</div>`,
            `        <p style="font-size: 12px; color: #94a3b8; margin: 0; font-weight: 500; line-height: 1.5;">Se ha radicado un nuevo informe en la plataforma GCM Auditor.</p>`,
            `      </div>`,
            `      `,
            `      `,
            `      <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px; border: 1px solid #16223f; border-radius: 14px; background-color: #0b1325;">`,
            `        <tr>`,
            `          <td style="width: 50%; padding: 12px 15px; text-align: center; border-right: 1px solid #16223f;">`,
            `            <span style="font-size: 8px; font-weight: 800; color: #475569; display: block; letter-spacing: 1px; margin-bottom: 4px; text-transform: uppercase;">ESTADO</span>`,
            `            <span style="font-size: 12px; font-weight: 900; color: #ffffff;"><span style="color: #10b981; font-size: 14px; vertical-align: middle; margin-right: 3px;">●</span> NUEVO</span>`,
            `          </td>`,
            `          <td style="width: 50%; padding: 12px 15px; text-align: center;">`,
            `            <span style="font-size: 8px; font-weight: 800; color: #475569; display: block; letter-spacing: 1px; margin-bottom: 4px; text-transform: uppercase;">PRIORIDAD</span>`,
            `            <span style="font-size: 12px; font-weight: 900; color: #ef4444;"><span style="vertical-align: middle; margin-right: 3px;">🚩</span> ALTA</span>`,
            `          </td>`,
            `        </tr>`,
            `      </table>`,
            `      `,
            `      `,
            `      <div style="border: 1px solid #16223f; border-radius: 14px; background-color: #0b1325; padding: 4px 16px; margin-bottom: 20px;">`,
            `        <table style="width: 100%; border-collapse: collapse; font-size: 11px; font-weight: 600;">`,
            `          <tr style="border-bottom: 1px solid #16223f;"><td style="padding: 12px 0; color: #64748b;">🏢 Proceso</td><td style="padding: 12px 0; color: #ffffff; text-align: right; font-weight: 700; text-transform: capitalize;">${emailParams.proceso_auditado}</td></tr>`,
            `          <tr style="border-bottom: 1px solid #16223f;"><td style="padding: 12px 0; color: #64748b;">👤 Responsable</td><td style="padding: 12px 0; color: #ffffff; text-align: right; font-weight: 700;">${nombreAuditorIdentificado}</td></tr>`,
            `          <tr style="border-bottom: 1px solid #16223f;"><td style="padding: 12px 0; color: #64748b;">📅 Fecha</td><td style="padding: 12px 0; color: #ffffff; text-align: right; font-weight: 700;">2026</td></tr>`,
            `          <tr><td style="padding: 12px 0; color: #64748b;">🗂️ Tipo de novedad</td><td style="padding: 12px 0; color: #10b981; text-align: right; font-weight: 700;">Hallazgo</td></tr>`,
            `        </table>`,
            `      </div>`,
            `      `,
            `      `,
            `      <div style="border: 1px solid #16223f; border-radius: 14px; background-color: rgba(16,185,129,0.02); padding: 16px; margin-bottom: 25px; min-height: 55px;">`,
            `        <table style="width: 100%; border-collapse: collapse;">`,
            `          <tr>`,
            ...
            `              <div style="font-size: 9px; font-weight: 800; color: #10b981; letter-spacing: 1px; margin-bottom: 4px; text-transform: uppercase;">RESUMEN DEL INFORME</div>`,
            `              <div style="font-size: 12px; color: #e2e8f0; font-weight: 600; line-height: 1.4;">${emailParams.titulo_informe}</div>`,
            `            </td>`,
            `          </tr>`,
            `        </table>`,
            `      </div>`,
            ...
            `      `,
            `      <div style="text-align: center; margin-bottom: 25px;">`,
            `        <a href="${emailParams.enlace_pdf}" style="display: block; background-color: #10b981; color: #ffffff; font-size: 12px; font-weight: 800; text-decoration: none; padding: 13px 20px; border-radius: 12px; text-transform: uppercase; letter-spacing: 1px; text-align: center; box-shadow: 0 4px 12px rgba(16,185,129,0.25);">`,
            `          Ver Informe Completo &nbsp; ➔`,
            `        </a>`,
            `      </div>`,
            `      `,
            `      `,
            `      <div style="border-top: 1px solid #16223f; padding-top: 20px;">`,
            `        <table style="width: 100%; border-collapse: collapse;">`,
            `          <tr>`,
            `            <td style="width: 36px; vertical-align: top;">`,
            `              <div style="width: 30px; height: 30px; line-height: 30px; border-radius: 50%; background-color: #0f172a; text-align: center; font-size: 13px; color: #94a3b8; border: 1px solid #16223f;">🔒</div>`,
            `            </td>`,
            `            <td style="padding-left: 12px; vertical-align: middle; text-align: left; font-size: 10px; color: #475569; font-weight: 600; line-height: 1.4;">`,
