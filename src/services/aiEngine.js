...
// 1. Configuración del cliente Gemini con tu variable existente
...
// 2. Capa de Sistema (Identidad y Reglas del Auditor GRC)
const SYSTEM_PROMPT = `
...
// 3. Capa de Módulo (Contexto del Riesgo)
...
// 4. Capa de Salida y Formato (Estructura de la Respuesta)
...
export const analizarRiesgoConIA = async (datosRiesgo) => {
  try {
    // Ensamblaje de las 3 capas del Prompt
    const fullPrompt = `
${SYSTEM_PROMPT}
